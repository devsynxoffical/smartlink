...
export const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1544197150-199123fc639e?auto=format&fit=crop&w=800&q=80',
    heroImage: '/services_hero_bg.jpg',
    iconName: 'Cloud',
    details: {
...
export const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    category: 'Retail',
    categoryLabel: 'RETAIL',
    description: 'Network infrastructure and security systems for multiple regional store locations.',
  ...
  },
  {
    ...
    category: 'Retail',
    categoryLabel: 'RETAIL',
    description: 'Cabling infrastructure and technology solutions to support 24/7 supply chain and retail operations.',
  ...
  },
  {
    ...
    category: 'Retail',
    categoryLabel: 'RETAIL',
    description: 'Structured cabling and advanced security systems for an iconic luxury flagship location.',
  ...
  },
  {
    ...
    description: 'Delivering tailored solutions for businesses of all sizes, across industries nationwide.',
